...
namespace GameMain
{
    ...
    public class NetworkReader
    {
        ...
        /// <summary>
        /// Reads any data type that  supports
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public T Read<T>()
        {
            ...
            {
                logger.LogError($"No reader found for {typeof(T)}. Use a type supported by  or define a custom reader");
                return default;
            }
    ...
    // 's Weaver automatically detects all NetworkReader function types,
