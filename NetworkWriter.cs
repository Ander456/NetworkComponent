...
namespace GameMain
{
    ...
    public class NetworkWriter
    {
        ...
        public void Write<T>(T value)
        {
            ...
            {
                logger.LogError($"No writer found for {typeof(T)}. Use a type supported by  or define a custom writer");
            }
            else
            {
    ...
    // 's Weaver automatically detects all NetworkWriter function types,
