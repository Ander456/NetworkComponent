...
namespace kcp2k
{
    ...
    public class KcpTransport : Transport
    {
        ...
        public uint SendWindowSize = 4096; //Kcp.WND_SND; 32 by default.  sends a lot, so we need a lot more.
        [Tooltip("KCP window size can be modified to support higher loads.")]
        public uint ReceiveWindowSize = 4096; //Kcp.WND_RCV; 128 by default.  sends a lot, so we need a lot more.
        ...
        public void LateUpdate()
        {
            ...
            // (see also: https://github.com/vis2k//pull/379)
            if (!enabled)
                return;
...
//#endif  <- commented out because  isn't defined on first import yet
