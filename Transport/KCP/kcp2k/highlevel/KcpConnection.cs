...
namespace kcp2k
{
    ...
    public abstract class KcpConnection
    {
        ...
        // needs a way to stop the kcp message processing while loop
        // immediately after a scene change message.  can't process any
            ...
            if (msgLength > 0)
            {
                ...
                switch (channel)
                {
                    ...
                    case (byte)KcpChannel.Unreliable:
                    {
                        ...
                        {
                            // only process messages while not paused for 
                            // scene switching etc.
        ...
        public void Unpause()
        {
            ...
            // doesn't mean we should disconnect. for example,  pauses
